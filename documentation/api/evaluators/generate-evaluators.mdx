...
| Method | Endpoint |
|--------|----------|
| `POST` | `https://new-prod.cekura.ai/test_framework/v1/scenarios-external/generate/` |
...
```bash Curl
curl -X POST https://new-prod.cekura.ai/test_framework/v1/scenarios-external/generate/ \
...
def generate_evaluators(api_key, agent_id, num_scenarios, **kwargs):
    url = 'https://new-prod.cekura.ai/test_framework/v1/scenarios-external/generate/'
...
async function generateEvaluators(apiKey, agentId, numScenarios, options = {}) {
  const url = 'https://new-prod.cekura.ai/test_framework/v1/scenarios-external/generate/';
