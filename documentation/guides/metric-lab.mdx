...
<Note>
**Credit consumption**: Auto Improve costs `iterations × test set size × 0.2 credits`. For example, 10 iterations over 100 test examples costs approximately 200 credits. If the optimizer terminates early, you only pay for the iterations that ran.
</Note>
