...
A single Cekura organization can contain multiple projects. The number of projects available depends on your plan — Developer accounts include 1 project; paid plans support multiple projects. If you reach your plan's project limit, you will see a `400: Max projects limit reached` error when attempting to create a new project.
