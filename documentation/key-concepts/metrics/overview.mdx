...
#### Running Metrics
- **Testing**: Each evaluator has a list of metrics attached to it. When running simulations, a metric is executed when it is both attached to the evaluator and enabled on the agent.
