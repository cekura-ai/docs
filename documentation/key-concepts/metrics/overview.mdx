...
1. **Pre-defined Metrics**: These are generic metrics such as CSAT, pitch, latency, and interruption count. These are defined by Cekura. You can read more about each pre-defined metric [here](#link-to-predefined-metrics-page).
