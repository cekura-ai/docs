---
title: "Single-Turn Red Teaming"
sidebarTitle: "Single-Turn"
icon: "message"
iconType: "regular"
description: "Test your AI agent against 32,000+ single-turn adversarial prompts"
---
...
<CardGroup cols={2}>
  <Card title="Multi-Turn Red Teaming" icon="comments" href="/documentation/red-teaming/multi-turn">
    Test your agent against sustained adversarial conversations that span multiple turns
  </Card>
  <Card title="Red Teaming Overview" icon="shield-halved" href="/documentation/red-teaming/overview">
    Learn about the fundamentals of red teaming for AI agents
  </Card>
</CardGroup>
