...
#### Voice Settings
- **Voice Model**: Select a voice provider (ElevenLabs or Cartesia Sonic 3)
- **Voice ID**: Choose a voice from the available options. Use the play button to preview voices before selecting.
- **Background Noise**: Enable or disable background noise during conversations
