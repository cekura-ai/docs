...
<Note>
**API key management requires Admin role.** Only users with the **Admin** role can create or manage API keys. Members and Viewers do not have access to the **Settings > API Keys** section. If you need an API key, contact your organization's Admin to have one generated and shared with you.
</Note>
