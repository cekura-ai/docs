  ...
  <Tab title="No-code from VAPI">
    ...
    <Steps>
      ...
      <Step title="Obtain your Cekura API key">
        Navigate to the API Keys section in your [Cekura dashboard](https://dashboard.cekura.ai) by clicking on **Settings **button.

        ![Navigate to API Keys](/Cekura_home.png)

        Copy your private API key from the modal:

        ![Copy API Key](/images/get-vocera-api-key-2.png)
