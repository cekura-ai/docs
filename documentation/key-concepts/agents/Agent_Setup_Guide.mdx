...
<AccordionGroup>
  ...
  <Accordion title="Provider Chat">
    ...
    <Note>Native provider chat is only available with [ElevenLabs](/documentation/integrations/elevenlabs/observability), [VAPI](/documentation/integrations/vapi/testing), [LiveKit](/documentation/integrations/livekit/testing), [Retell](/documentation/integrations/retell/testing), Bland AI, and Kore.ai.</Note>

    Provider chat uses your voice agent settings automatically. Some providers require additional configuration:
    - **Retell** and **Bland AI** — enter a separate chat agent ID.
    - **Kore.ai** — enter your Kore.ai API Secret (xo-webclient API key) and optionally a custom host. Add `api.cekura.ai` to your whitelist in the Kore.ai Web Client configuration.
