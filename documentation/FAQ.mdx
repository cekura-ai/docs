...
## Where can I find the Master Software Agreement template and the Ordering Terms and Conditions, including details on credit rollover and overage billing?

For enterprise customers looking to integrate Cekura into their internal product catalogs or procurement systems, the Master Software Agreement (MSA) and Ordering Terms are handled as follows:

### 1. Master Software Agreement (MSA)
The MSA template for large enterprises is available upon request. Because these agreements often require specific legal tailoring for enterprise compliance, they are provided directly by the **Cekura Sales or Legal team**. Please reach out to your designated account representative to receive the most recent template for your legal review.

### 2. Ordering Terms and Conditions
Ordering Terms, which include the specific legal and financial framework for your subscription, are typically found in your signed **Service Order Form**. These terms provide the boilerplate information needed for internal product catalogs, including:
*   **Credit Allocation:** The total number of credits provided for testing (generating and running evaluators) and monitoring (evaluating call recordings and transcripts).
*   **Monthly Rollover:** Details on whether unused credits expire at the end of the billing cycle or roll over to the next month are defined in your specific plan terms. Enterprise plans often feature custom rollover provisions.
*   **Overage Billing:** The specific rates and billing cycles for usage that exceeds your monthly credit limit are outlined in the 'Fees and Payment' section of your Ordering Terms.

### 3. Monitoring Usage and Credits
You can track your real-time credit consumption and view your current subscription status directly within the Cekura platform. This ensures transparency in how your AI agent testing and monitoring activities impact your balance. For more information on how metadata and metrics are used to evaluate your calls—which drives credit consumption—you can refer to our documentation on [Basic and Advanced Metrics](https://docs.cekura.ai/documentation/key-concepts/metrics/basic-advanced-metrics#2-metadata).
