...
<Note>
Dashboards visualise your observability (live production call) data. For evaluation run quality reports — scenario outcomes, metric scores, and improvement suggestions — see the [Result Page and Runs Overview](/documentation/FAQ#how-can-i-access-an-overall-report-of-the-results) in the dashboard UI, or use the [`/cekura-report` command](/mcp/claude-code-guide) via Claude Code.
</Note>
