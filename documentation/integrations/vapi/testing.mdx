...
![Organization Settings Navigation](/createanagent.png)
...
![VAPI API Configuration](/vapi_agentsettings.png)
...
## Setting Up VAPI Integration (Across Agents)
...
![VAPI API Configuration](/Cekura_home.png)

### 2. Configuring the VAPI API Key
