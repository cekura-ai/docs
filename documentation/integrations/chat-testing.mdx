...
<Steps>
  <Step title="Optionally Create a Dedicated Chat Agent">
    By default, Retell chat runs clone a temporary chat agent from the voice agent automatically — no separate agent needed. If you want to point chat runs at a specific Retell chat agent:
  ...
  <Step title="Configure in Cekura">
    ...
    2. Under **Integration Settings**, enter the **External Assistant ID** of your Retell chat agent (if you created one) and your **Retell API Key**
    3. Click **Save Changes**
