...
<Note>
**Plan availability:** The Viewer role is available on quarterly and yearly Enterprise subscription plans only. Organizations on self-serve plans or monthly subscriptions cannot assign the Viewer role to members.
</Note>
