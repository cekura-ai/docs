...
2. **Success Impact:** Toggle **Affects Conversation Success** to `True` if this metric is critical (i.e., if this fails, the entire conversation is considered a failure).
