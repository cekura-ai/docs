...
<Steps>
  <Step title="Get Connect Widget Credentials">
    ...
    3. Copy the following values:
       - **Widget ID** — the UUID from your widget configuration
       - **Snippet ID** — the base64-encoded KMS snippet
       - **Security Token** — the x-amz-security-token value
       - **Connect Host** — your instance hostname (e.g., `yourinstance.my.connect.aws`)
  ...
  <Step title="Configure in Cekura">
    ...
    2. Under **Integration Settings**, enter:
       - **Widget ID** — your Connect widget UUID
       - **Snippet ID** — the base64 KMS snippet from your widget
       - **Security Token** — the x-amz-security-token
       - **Connect Host** — your instance hostname
