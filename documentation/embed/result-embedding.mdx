...
```
https://dashboard.cekura.ai/embed/{agentId}/result/{resultId}?token={token}
```
...
const VoceraEmbed = ({ agentId, resultId = 'all' }) => {
  ...
  return (
    <iframe
      src={`https://dashboard.cekura.ai/embed/${agentId}/result/${resultId}?token=${token}`}
...
export default {
  ...
  computed: {
    embedUrl() {
      return `https://dashboard.cekura.ai/embed/${this.agentId}/result/${this.resultId}?token=${this.token}`;
    }
  },
  methods: {
...
export class VoceraEmbedComponent implements OnInit, OnDestroy {
  ...
  get embedUrl(): SafeUrl {
    const url = `https://dashboard.cekura.ai/embed/${this.agentId}/result/${this.resultId}?token=${this.token}`;
...
class VoceraEmbed {
  ...
  updateIframe() {
    if (this.iframe && this.token) {
      this.iframe.src = `https://dashboard.cekura.ai/embed/${this.agentId}/result/${this.resultId}?token=${this.token}`;
    }
  }
