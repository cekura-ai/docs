...
- `pipecat-agent-concurrency-limit-reached`: The Pipecat agent reached its concurrent session capacity limit.
- `pipecat-session-error`: Failed to create a Pipecat session.
