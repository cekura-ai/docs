...
If your metric references variables that aren't available, Cekura appends a warning showing which variables couldn't be accessed:

```
⚠️ Not able to access variables: {{customer_name}}, {{order_id}}
```

This helps you identify missing data and troubleshoot why your metric might not evaluate as expected.
