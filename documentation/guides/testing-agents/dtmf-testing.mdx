...
<Warning>
**Send DTMF** and **Receive DTMF** cannot be enabled on the same evaluator. Use Send DTMF when your evaluator needs to press buttons, or Receive DTMF when your evaluator needs to detect button presses from the main agent.
</Warning>
