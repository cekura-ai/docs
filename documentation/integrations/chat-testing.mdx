...
<Info>
Pipecat Chat runs against your Pipecat Cloud deployment, the same bot that serves voice. See the [Pipecat Chat Testing guide](/documentation/integrations/pipecat/chat-testing) for details.
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Pipecat Chat run fails before the conversation starts">
    Check the Pipecat API key and agent name in Agent Settings, that the deployment has free capacity, and that RTVI is enabled on the bot. See [Pipecat Chat troubleshooting](/documentation/integrations/pipecat/chat-testing#troubleshooting).
  </Accordion>
