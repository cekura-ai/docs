...
| Method | Endpoint |
|--------|----------|
| `GET` | `https://new-prod.cekura.ai/test_framework/v1/scenarios-external/:scenario-id/` |
...
```bash Curl
curl -X GET https://new-prod.cekura.ai/test_framework/v1/scenarios-external/:scenario-id/ \
