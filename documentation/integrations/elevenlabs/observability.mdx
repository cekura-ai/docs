...
<Tabs>
  ...
  <Tab title="No-code ElevenLabs Integration">
    ...
    <Steps>
      ...
      <Step title="Copy your webhook secret from ElevenLabs">
        In your ElevenLabs agent's webhook settings, copy the **Webhook Secret**. Cekura uses this secret to verify incoming webhooks and protect against replay attacks.

        <Warning>
        Webhook requests will be rejected if the secret is not configured in Cekura.
        </Warning>
      </Step>
      ...
      <Step title="Add credentials to Cekura">
        ...
        3. Enter the **Webhook Secret** you copied from ElevenLabs
