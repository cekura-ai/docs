...
2. The notification includes your current credits, the threshold(s) that were crossed and organization name
3. You only receive one notification per threshold breach — each threshold alerts independently. If several thresholds are crossed at once, a single email lists all of them
