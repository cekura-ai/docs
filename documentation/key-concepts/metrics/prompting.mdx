...
<Note>
 Refer to the test agent in first person like "You are". Do not provide exact steps like when AI Agent says "xyz", do this. Do not mention exact line to speak unless necessary. Keep all information separate in information block.
</Note>
...
```
- The Main Agent asks for Name adn Date of Birth 
