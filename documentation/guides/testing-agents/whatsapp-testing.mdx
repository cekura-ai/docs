...
<Steps>
  <Step title="Enable WhatsApp on Twilio">
    ...
    <Frame>
      <img src="/images/whatsapp/twilio-whatsapp-sender-config.png" alt="Twilio WhatsApp Sender Configuration" />
    </Frame>

    <Note>
    See [Twilio's WhatsApp setup guide](https://www.twilio.com/docs/whatsapp/quickstart) for details on enabling WhatsApp for your phone number.
    </Note>
  </Step>
