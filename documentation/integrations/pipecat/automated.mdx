...
This page covers voice testing. To run the same deployment as a text conversation, see [Pipecat Chat Testing](/documentation/integrations/pipecat/chat-testing).
