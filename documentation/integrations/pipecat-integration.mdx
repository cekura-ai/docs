...
sidebarTitle: "Pipecat Integration"
icon: "/logo/pipecat_icon1.svg"
description: 'Run evaluator scenarios by manually providing Pipecat room URL and access token'
---
