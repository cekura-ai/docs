...
| Method | Endpoint |
|--------|----------|
| `GET` | `https://new-prod.cekura.ai/test_framework/v1/personalities-external/` |
...
```bash Curl
curl -X GET https://new-prod.cekura.ai/test_framework/v1/personalities-external/ \
...
def list_personalities(api_key):
    url = 'https://new-prod.cekura.ai/test_framework/v1/personalities-external/'
    headers = {
...
async function listPersonalities(apiKey) {
  const url = 'https://new-prod.cekura.ai/test_framework/v1/personalities-external/';
