...
- `exceeded-max-duration`: Call reached the maximum allowed duration. These calls display a **Review Required** status badge and a yellow warning icon in the metrics table, indicating they may need manual review to verify the agent's behavior before the timeout.
