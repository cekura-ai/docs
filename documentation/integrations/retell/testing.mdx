...
<Accordion title="Advanced: Custom LiveKit Server URL">
  If your Retell agent is deployed to a specific region, you can override the default LiveKit server URL in the Agent Settings page. Enter the LiveKit server URL that corresponds to your Retell region (for example, `wss://retell-ai-4ihahnq7.livekit.cloud`).

  Most users can leave this field empty to use the default server.
</Accordion>
