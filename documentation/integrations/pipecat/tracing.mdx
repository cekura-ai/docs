...
<Note>
For [Pipecat Chat](/documentation/integrations/pipecat/chat-testing) runs, pass `runner_args` to the tracer. The SDK detects text sessions from it and, for those sessions only, records typed turns, skips audio recording, and reports tool calls in full. Voice sessions are unchanged.
</Note>
