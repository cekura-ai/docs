...
<Note>
Generating insights costs **10 credits per eligible metric**. If you have a view filter active, only the visible metrics are charged. When your balance is insufficient, the action returns a 402 error and no insights are queued.
</Note>
