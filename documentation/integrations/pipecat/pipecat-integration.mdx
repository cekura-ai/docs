---
title: 'Pipecat (Manual)'
description: 'Run evaluator scenarios by manually providing Pipecat room URL and token'
---
...
- Pipecat room URL and a valid token for each run you intend to start

<Note>
  For automated Pipecat Cloud integration where Cekura handles room creation and token generation, see [Pipecat (Automated)](/documentation/integrations/pipecat/testing).
</Note>
