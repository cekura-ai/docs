...
<Note>
The Tools section only appears for **Instruction-based** evaluators. Structured Test Case evaluators use the `<dtmf>` tag instead—see [Using the DTMF Tag in Structured Tests](#using-the-dtmf-tag-in-structured-tests) below.
</Note>
