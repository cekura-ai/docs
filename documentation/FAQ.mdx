...
## Where can I find the Test Profile in Cekura?

To find the **Test Profile**, navigate to the **Evaluator** section of the Cekura platform. You will find the Test Profile options located at the top of the Evaluator page.

### Steps to Locate the Test Profile:
1. Log in to your Cekura dashboard.
2. Click on the **Evaluator** tab in the navigation menu.
3. Look at the top of the screen to access and manage your Test Profiles.

### Why is the Test Profile important?
The Test Profile is a key component of the testing workflow. It allows you to define the context and parameters for your evaluators (test cases) before you run them against your AI voice or chat agents. This ensures that the evaluation process is consistent and aligned with your specific testing requirements.

For more information on managing evaluators and testing workflows, you can visit the [Cekura Documentation](https://docs.cekura.ai/).
