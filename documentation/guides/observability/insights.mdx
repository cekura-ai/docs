...
The date selector to the left of the **Generate** button defaults to **Latest**, which shows the most recent insight for each metric. Select a specific date to view insights from that day. Clicking **Generate** resets the selector to **Latest** so your new insights appear immediately.
