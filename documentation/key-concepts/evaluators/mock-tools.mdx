...
2. **Add Mock Tool Data**
   ...
   - For each tool you need to add:
     - **Tool Name**: The exact tool name from your agent's configuration. Names can include letters, numbers, underscores, hyphens, and spaces (no leading or trailing spaces).
