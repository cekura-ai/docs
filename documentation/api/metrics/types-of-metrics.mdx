...
Cekura offers several types of metrics for analyzing evaluating calls. Each metric type serves a specific purpose and returns results in a standardized format.
