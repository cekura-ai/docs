...
| Method | Endpoint |
|--------|----------|
| `POST` | `https://new-prod.cekura.ai/test_framework/v1/scenarios-external/create_scenario_from_transcript/` |
...
```bash Curl
curl -X POST https://new-prod.cekura.ai/test_framework/v1/scenarios-external/create_scenario_from_transcript/ \
...
def create_evaluator_from_transcript(
    ...
    url = 'https://new-prod.cekura.ai/test_framework/v1/scenarios-external/create_scenario_from_transcript/'
...
async function createEvaluatorFromTranscript(apiKey, data) {
  const url = 'https://new-prod.cekura.ai/test_framework/v1/scenarios-external/create_scenario_from_transcript/';
