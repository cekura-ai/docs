...
If you need to test for **regional accent variation within a single language** (e.g. Scottish, Yorkshire, or Geordie accents in English), see [Accent Testing](/documentation/guides/testing-agents/accent-testing) instead — that scenario is different from cross-language testing and has its own evaluation workflow.
...
<Steps>
  ...
  <Step title="Pick or create a personality per language">
    Use a built-in personality (e.g. `Spanglish`) or create a [custom personality](/documentation/advanced/creating-custom-personalities) for the specific language or code-switching pattern you want to test.
...
- [Accent Testing](/documentation/guides/testing-agents/accent-testing) — Testing regional accent variation within a single language
