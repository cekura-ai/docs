...
<Note>
Cekura automatically supports Retell's PII-scrubbed webhook payloads. If your Retell account has `data_storage_setting` set to `"everything_except_pii"`, Cekura uses the scrubbed recording and transcript fields—no additional configuration required.
</Note>
