...
Cekura offers two approaches to red teaming:

<CardGroup cols={2}>
  <Card title="Single-Turn" icon="message" color="#6B7280">
    Tests individual attack prompts from our database of **32,617+ scenarios**. Good for testing immediate safety responses to known attack patterns.
  </Card>
  <Card title="Multi-Turn" icon="comments" color="#8184FF">
    AI-generated adversarial conversations spanning **5-10 turns**. Simulates persistent attackers who build rapport, adopt personas, and adapt their approach based on agent responses.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Single-Turn Red Teaming" icon="message" href="/documentation/red-teaming/usage">
    Test your agent against 32,000+ individual attack prompts
  </Card>
  <Card title="Multi-Turn Red Teaming" icon="comments" href="/documentation/red-teaming/multi-turn">
    Test against sustained adversarial conversations
  </Card>
</CardGroup>
