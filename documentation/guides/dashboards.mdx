...
<Frame caption="Create an alert straight from a metric widget's ⋮ menu.">
  <img src="/images/dashboards/create-alert-from-widget.png" alt="Create alert from widget menu" />
</Frame>
