  ...
  <Tab title="Auto-fetch">
    ...
    <Steps>
      ...
      <Step title="Add credentials to Cekura">
        ...
        <Note>
          Auto-fetch requires your Retell API key to have the **History.Read** scope to retrieve call history. If the key lacks this scope, Cekura will receive a 403 error from Retell and automatically disable auto-fetch to prevent a recurring error loop.
        </Note>
      </Step>
