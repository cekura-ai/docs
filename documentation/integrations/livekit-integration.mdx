...
<Note>
For issues with agent dispatch failures or join latency in production (e.g., recipients hearing silence on outbound calls), see [Agent Dispatch Reliability](/documentation/integrations/livekit/reliability) for mitigation strategies.
</Note>
