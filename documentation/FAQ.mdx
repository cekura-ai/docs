...
Yes, Cekura offers native API integration with Telnyx AI Assistants. This integration automatically syncs prompts from your Telnyx agent to Cekura, so your agent description stays current without manual updates.

### Available Features

- **Auto-sync prompt**: Cekura fetches and syncs your Telnyx agent's prompt every 30 seconds
- **SMS and WhatsApp chat testing**: Test your Telnyx agent through text-based channels
- **Standard voice testing**: Test your agent via phone calls using the assigned Telnyx phone number

### Setup Steps

1. **Create or edit an agent** in the Cekura dashboard
2. **Select Telnyx** as the provider
3. **Enter your Telnyx API key** and assistant ID
4. **Enable auto-sync prompt** to keep your agent description current
5. **Configure your connection type** (telephony, SMS, or WhatsApp)

### Important Considerations

- **Tool call testing**: Mock tool functionality requires auto-sync prompt to be enabled, which fetches tool definitions from your Telnyx agent
- **WebRTC**: Direct WebRTC testing is not currently available for Telnyx; use telephony or chat-based testing instead

For more on configuring your agent, see the [Agent Setup Guide](https://docs.cekura.ai/documentation/key-concepts/agents/Agent_Setup_Guide).
