...
icon: "comments"
iconType: "regular"
description: "Advanced adversarial testing with multi-turn conversation attacks that simulate persistent attackers"
---

## What is Multi-Turn Red Teaming?

Multi-turn red teaming generates **sustained adversarial conversations** that span 5-10 turns, simulating how a determined attacker might gradually manipulate your AI agent through progressive conversation strategies.

Unlike single-turn attacks that test individual prompts, multi-turn attacks:
...
<CardGroup cols={2}>
  <Card title="Single-Turn" icon="message" color="#6B7280">
    Tests individual attack prompts in isolation. Good for testing immediate safety responses.
  </Card>
  <Card title="Multi-Turn" icon="comments" color="#8184FF">
    Simulates persistent attackers who adapt over multiple conversation turns. Tests your agent's ability to maintain safety boundaries throughout extended interactions.
  </Card>
</CardGroup>

## Attack Categories

Multi-turn red teaming covers **6 attack categories** organized into 4 groups:
...
<Warning>
  Multi-turn attacks are more sophisticated than single-turn attacks. Even agents that pass single-turn tests may be vulnerable to sustained, persona-based attacks.
</Warning>

## Related

<CardGroup cols={2}>
  <Card title="Single-Turn Red Teaming" icon="message" href="/documentation/red-teaming/usage">
    Learn about single-turn red teaming with our database of 32,000+ attack prompts
  </Card>
  <Card title="Red Teaming Overview" icon="shield-halved" href="/documentation/red-teaming/overview">
    Understand the fundamentals of red teaming for AI voice agents
  </Card>
</CardGroup>
