---
title: "SMS During Call"
sidebarTitle: "SMS During Call"
icon: "message"
iconType: "regular"
...
<Note>
The Tools section only appears for **Instruction-based** evaluators. Structured Test Case evaluators use the `<send_sms>` tag instead—see [Structured Tests](/documentation/key-concepts/evaluators/conditional-actions#send_sms---send-sms) for details.
</Note>
