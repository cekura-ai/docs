...
Multilingual testing covers agents that serve users in *different languages* — Spanish, French, Hindi, etc. If your concern is regional accents or dialects *within* a single language (e.g. Scottish English, Yorkshire English), see [Accent & Dialect Testing](/documentation/guides/testing-agents/accent-testing) instead — the failure modes and metrics differ.
...
<Steps>
  ...
  <Step title="Pick or create a personality per language">
    ...
    For testing a *non-native accent* of English itself (e.g. a Spanish speaker's English), use the [Accent & Dialect Testing](/documentation/guides/testing-agents/accent-testing) workflow instead.
  </Step>
...
- [Accent & Dialect Testing](/documentation/guides/testing-agents/accent-testing) — Testing regional accents within the same language
- [Personality](/documentation/key-concepts/evaluators/personality) — How personalities control language and behavior
- [Creating Custom Personalities](/documentation/advanced/creating-custom-personalities) — Add a new language or code-switching pattern
