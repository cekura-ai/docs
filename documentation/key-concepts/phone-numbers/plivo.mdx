...
<Note>
  Send DTMF is only supported for Cekura, Plivo, and Telnyx phone numbers. Use your Plivo number, Telnyx number, or a Cekura-provided number for this functionality.
</Note>
