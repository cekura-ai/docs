...
<Frame>
  <img src="/images/agora/agora-select.png" alt="Select Agora in the provider grid" />
</Frame>

Then fill in the session-endpoint configuration:

<Frame>
  <img src="/images/agora/agora-session.png" alt="Agora session endpoint configuration" />
</Frame>
