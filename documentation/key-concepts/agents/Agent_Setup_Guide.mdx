...
<Tip>
For raw-PCM WebSocket voice agents, select **Custom** and enable the WebSocket (CHIRP) connection option. See [WebSocket Voice](/documentation/integrations/websocket-chirp) for details.
</Tip>
