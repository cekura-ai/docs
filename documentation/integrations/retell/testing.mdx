...
Auto-sync can also regenerate your Dropoff Nodes and Topic Nodes when it detects a prompt change—keeping conversation stage tracking and topic categorization aligned with your latest prompt.

To enable this, toggle on **Auto-update Dropoff Nodes** or **Auto-update Topic Nodes** in your agent settings.
