...
### Re-evaluate metrics within a single result

1. Navigate to the **Results** page for your project.
2. Click into a specific result to view its runs.
3. Select the checkboxes next to the runs you want to re-evaluate. You can select individual runs or use the header checkbox to select all.
4. Click the **Reevaluate Metrics** button that appears in the toolbar.
5. Choose the specific metrics you want to rerun from the list.
6. Confirm — Cekura will queue the evaluations and update the results.

### Re-evaluate metrics across multiple results

To re-evaluate metrics across multiple results at once:

1. Navigate to the **Results** page for your project.
2. Select the checkboxes next to the results you want to re-evaluate.
3. Click the **Reevaluate Metrics** button in the toolbar.
4. Choose the metrics to rerun.
5. Confirm — Cekura will queue evaluations for all selected results.
...
## How do I bulk delete results?

You can delete multiple results at once from the Results page. Deleting a result removes it and all associated runs from your project.

### Steps to bulk delete results

1. Navigate to the **Results** page for your project.
2. Select the checkboxes next to the results you want to delete.
3. Click the **Delete** button that appears in the toolbar.
4. Review the confirmation dialog showing how many results will be deleted.
5. Confirm to permanently delete the selected results.

<Warning>
Deleting results is permanent and cannot be undone. All runs and evaluation data associated with the deleted results will be removed.
</Warning>
