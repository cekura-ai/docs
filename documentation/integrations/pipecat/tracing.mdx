...
- For [Pipecat Chat](/documentation/integrations/pipecat/chat-testing) runs, a pipeline task created with `enable_rtvi=True` and `runner_args` passed to the tracer
