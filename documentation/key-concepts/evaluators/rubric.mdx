...
When viewing call or run details, you can see how your rubric rules evaluated in the **Rubric Card** section.

### What the Rubric Card Shows

The Rubric Card displays the pass/fail status of each rubric condition:

- **Failed conditions** appear prominently with explanations for why they failed
- **Passed conditions** are grouped separately and can be expanded to view details

The card automatically expands when there are failures, making it easy to identify issues at a glance.

### Navigating to the Full Rubric

Click **View Rubric** in the Rubric Card to navigate to the full rubric configuration page where you can adjust your rules.
