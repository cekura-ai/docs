...
<Note>
**Unanswered Calls**: Calls that never connected (missing start time for runs, or zero duration for call logs) are always marked as failure, regardless of rubric rules. This prevents connection failures from being counted as successful evaluations.
</Note>
