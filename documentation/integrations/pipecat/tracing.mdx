...
<Note>
  If you currently send call data to `observability/v1/observe/` and want to adopt the SDK — or are wondering whether both can run simultaneously — see [Can I use the Pipecat SDK and the direct observability API together?](/documentation/FAQ#can-i-use-the-pipecat-sdk-observe_pipeline-and-the-direct-observability-api-observabilityv1observe-together-for-the-same-session) in the FAQ.
</Note>
