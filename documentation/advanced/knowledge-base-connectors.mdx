...
| `sync_interval_hours` | integer | 24 | Interval in hours between automatic syncs (e.g., 1 for hourly, 2 for every 2 hours, 24 for daily). Note: The API uses `sync_interval_minutes` internally. |
