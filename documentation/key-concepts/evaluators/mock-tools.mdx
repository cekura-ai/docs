...
#### Automatic Metric and Rubric Rule

<Note>
  When you enable mock tools on an agent, Cekura automatically adds the **Mock tool call accuracy** metric to your project and creates a rubric rule requiring a score of 5 to pass. This ensures evaluations verify that your agent called the correct mock tools with the correct inputs.

  You can adjust the threshold or remove this rule in your project's **Rubric Configuration** if a perfect score isn't required for your use case.
</Note>
