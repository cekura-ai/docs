...
This page covers **voice** testing over WebRTC, where Cekura joins the Daily room as an audio participant. For **text** testing over RTVI against the same deployment, see [Pipecat Chat Testing](/documentation/integrations/pipecat/chat-testing).
