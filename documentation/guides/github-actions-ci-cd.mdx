...
<Note>
This guide covers **triggering evaluator runs** in CI/CD. For voting on metric results, flagging false positives, and submitting metric feedback programmatically, see [Vote on a Metric Result](/cli-sdk/runs#vote-on-a-metric-result) in the CLI & SDK reference.
</Note>
