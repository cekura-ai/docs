...
Navigate to the settings and find API Keys section in sidebar in your [Cekura Dashboard Settings](https://dashboard.cekura.ai/dashboard/settings):

<img src="/images/cekura/get-cekura-api-key-1.png" alt="Navigate to API Keys" />

Copy your private API key from the page:

<img src="/images/cekura/get-cekura-api-key-2.png" alt="Copy API Key" />
