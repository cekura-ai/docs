...
*   **Audio LLM Judge Evaluation:** 0.3 credits per minute of audio evaluated, with a minimum of 0.2 credits. When using audio slicing parameters, you are charged only for the audio segment evaluated.
