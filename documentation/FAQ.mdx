...
4. **Initiate the Run:** In the Configure Run dialog, select your chat connection type from the connections grid (e.g., **WebSocket** or **Chat**) and click **Run**. Cekura will then use your configured digital interface instead of attempting to dial a phone number.
