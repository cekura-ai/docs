...
<Steps>
  <Step title="Open Cekura Agent">
    After logging in or completing onboarding, you land directly on the Cekura
    Agent page. You can also reach it by clicking **Cekura Agent** in the left
    sidebar or navigating to `/ai-assistant`.
  </Step>
