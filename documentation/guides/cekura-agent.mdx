...
- **No dashboard or widget management.** The agent cannot create, edit, or
  manage dashboards or widgets. Use the regular Cekura UI for dashboard
  operations. Dashboard management support is planned for a future release.
