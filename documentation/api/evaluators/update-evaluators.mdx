...
| `max_duration` | integer | No | Maximum call duration in seconds (10-3600). Overrides the project's default max call duration when set. |
...
| `max_duration` | integer\|null | Maximum call duration in seconds. `null` indicates the project default is used. |
