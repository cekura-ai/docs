...
### 4. Duplicate Profiles Across Agents

Reuse test profiles across different agents by duplicating them. Click the copy button on any test profile to create a copy for the same or a different agent. The duplicate will have "(Copy)" appended to its name—rename it as needed.
