...
### Dispatching Your Agent with Text Mode

<Warning>
Before calling the Cekura chat endpoint, you must create the room and dispatch your LiveKit agent with `text_mode: true` in the agent dispatch metadata. This tells your agent to operate in text/chat mode rather than voice mode.
</Warning>
