...
Select **Telephony** from the connections grid and click **Run** to execute your tests. Cekura automatically:
...
Select **WebSocket** from the connections grid and click **Run** to execute your tests. Cekura automatically:
...
Select **Chat** from the connections grid and click **Run** to execute your tests. Cekura automatically:
