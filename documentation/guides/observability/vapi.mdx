...
Forward the VAPI webhook response to Cekura as per the request body. The request body structure is shown in the example below.
</Step>
</Steps>

## Request Body Example

When forwarding VAPI responses, here's what the request body will look like when creating a new call log entry in Cekura:
