...
For more sophisticated testing against persistent, adaptive adversaries, see our [Multi-Turn Red Teaming](/documentation/red-teaming/multi-turn) feature. Multi-turn attacks use AI-driven strategies that evolve across 5-10 conversation turns based on your agent's responses.
