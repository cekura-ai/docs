...
<Steps>
  <Step title="Create Workflow File">
    ...
    jobs:
      test:
        ...
        with:
          agent_id: ${{ vars.AGENT_ID }}
          tags: ${{ vars.SCENARIO_IDS }}
        secrets:
          CEKURA_API_KEY: ${{ secrets.CEKURA_API_KEY }}
    ```

    Your workflow should look like this:
    <img src="/images/workflow-file-created.png" alt="Create Workflow File" />
  </Step>
  ...
  <Step title="Check Test Results">
    If you have set up things correctly, you can monitor results on [https://dashboard.cekura.ai/](https://dashboard.cekura.ai/) in the Results section.

    <img src="/images/workflow-results.png" alt="Workflow Results" />
  </Step>
</Steps>
...
For more examples and templates, visit the [Cekura GitHub Actions repository](https://github.com/cekura-ai/vocera-github-actions).
