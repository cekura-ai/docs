...
2. Copy your organization's webhook URL from the agent settings
...
3. Copy the webhook URL displayed in the agent settings—this URL is the same for all agents in your organization
