...
|---------|---------|--------------|
| **Test Profile** | Persona facts the evaluator uses to play a realistic caller | Evaluator (testing agent) |
| **Dynamic Variables** | Per-call values injected into your agent's system prompt via `{{...}}` placeholders | Your agent (main agent) |
