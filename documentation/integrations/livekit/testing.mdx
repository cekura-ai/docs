...
**agent_name** (string, optional): Override the agent name configured in your agent settings. Takes precedence over the value stored in your LiveKit credentials.

**room_config** (object, optional): Override or extend room configuration. Values are merged with any config set in your agent settings, with request values taking precedence.
