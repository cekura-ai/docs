...
You can optionally set a third variable:

- **`_confidence`** - An integer from 0–100 indicating how confident the evaluation is (defaults to 100 when a result is produced, or `None` when the metric couldn't compute a result)
