...
<Tip>
To edit the raw JSON configuration directly, click the **JSON Mode** button in the top-right corner of the Conditional Actions editor. You can switch between UI Mode and JSON Mode at any time—your changes will be validated when switching modes or saving.
</Tip>
