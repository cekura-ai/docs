...
<Note>
Each generation costs **20 credits**. If your balance is insufficient, the request returns a 402 error and no analysis is queued. Clicking **Generate** while an analysis is already running returns the in-progress run without charging again.
</Note>
