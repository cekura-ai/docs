...
Infrastructure Suite includes 18+ test scenarios covering hold tests, audio quality under various conditions, interruption handling, mute/silence handling (testing how your agent responds when the caller goes silent or mutes), language support, and edge cases like packet loss and rapid-fire phrases.

<img src="/images/infra_suite/Infra_test_suite_scenarios.png" alt="Complete list of Infrastructure Suite test scenarios" />

<Note>
**Migrating between voice providers?** If you are moving from one voice stack to another (e.g., Vapi → LiveKit, or rebuilding your event loop), Infrastructure Suite is the recommended starting point for validating that your new setup correctly handles pauses, interruptions, caller silence/muting, and other real-time audio behaviors. Add the suite to your project and run it against your new provider before writing custom evaluators.
</Note>
