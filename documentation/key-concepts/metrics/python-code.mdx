...
To call LLM Judge metrics from your Python code, you can use the helper functions. These functions require your API key, a description or prompt for the metric, and the metric type.
