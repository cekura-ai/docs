...
## Is there a limit when exporting test results?

Yes. When exporting test results from the Results page, exports are limited to 1,000 results. If your query returns more than 1,000 results, only the first 1,000 will be included in the export file.

If you need to export larger datasets, use the [Results API](/api-reference/test_framework/list-results) with pagination to retrieve all results programmatically.
