...
<ParamField path="api_key" type="str | None" default="None">
  Your Cekura API key for authentication. This parameter is optional—the system automatically provides authentication when running within custom code metrics, so you typically don't need to pass an API key.
</ParamField>
...
# api_key is optional - the system provides authentication automatically
response = evaluate_llm_judge_metric(data, description=description, eval_type="binary_workflow_adherence")
...
# api_key is optional - the system provides authentication automatically
response = evaluate_basic_metric(data, description=description, eval_type="binary_workflow_adherence")
_result = response.get("result")
_explanation = response.get("explanation")
```
...
# api_key is optional - the system provides authentication automatically
response = evaluate_advance_metric(data, prompt=prompt, eval_type="binary_workflow_adherence")
_result = response.get("result")
_explanation = response.get("explanation")
```
