...
- [Auto-Fetch Mock Tools](/api-reference/test_framework/auto-fetch-agent-mock-tools) — discover tools from your provider and generate mock data
- [Enable Mock Tools](/api-reference/test_framework/enable-agent-mock-tools) / [Disable Mock Tools](/api-reference/test_framework/disable-agent-mock-tools) — toggle mock mode on the provider
- [Execute Mock Tool](/api-reference/test_framework/post-mock-tool) — the runtime endpoint your agent calls to receive mock output
