...
<Note>
  Destructive operations (deleting agents, scenarios, metrics, etc.) are
  disabled for safety — perform deletes in the regular Cekura UI.
</Note>
...
- **Feedback welcome.** [Share feedback](mailto:support@cekura.ai) if you run
  into rough edges.
