...
<Note>
To change the personality of multiple evaluators at once, select them in the evaluator list and use **Improve Scenarios** to describe the change in natural language — e.g., *"Change the personality to English – Casual for all selected scenarios."* See [Bulk Evaluator Updates](/documentation/FAQ#is-there-a-way-to-mass-update-expected-outcomes-or-tags-for-a-particular-set-of-scenarios-using-the-improve-scenarios-feature) for a step-by-step guide.
</Note>
