...
| Method | Endpoint |
|--------|----------|
| `GET` | `https://new-prod.cekura.ai/test_framework/v1/scenarios-external/` |
...
{
    "count": 20,
    "next": "https://new-prod.cekura.ai/test_framework/v1/scenarios-external/?agent_id=4&page=2",
    "previous": null,
    "results": [
        {
            "id": 201,
...
```bash Curl
curl -X GET https://new-prod.cekura.ai/test_framework/v1/scenarios-external/ \
...
def get_evaluators(api_key, agent_id):
    url = 'https://new-prod.cekura.ai/test_framework/v1/scenarios-external/'
    headers = {
...
async function getEvaluators(apiKey, agentId) {
  const baseUrl = 'https://new-prod.cekura.ai/test_framework/v1/scenarios-external/';
