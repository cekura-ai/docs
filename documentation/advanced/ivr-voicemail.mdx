...
**First Message (Optional):** You can add the greeting here only which is showin in next line or You can leave this field empty if you want your agent to speak first.
