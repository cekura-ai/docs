...
## How do I renew a cancelled subscription?

If you cancelled your subscription but want to continue before your billing period ends, you can restore it directly from the Cekura dashboard without completing checkout again.

To renew your subscription:
1. Log in to your Cekura account.
2. Navigate to **Billing**.
3. Find your cancelled subscription and click **Renew Subscription**.

If your subscription has fully expired (the billing period has ended), clicking **Renew Subscription** will redirect you to complete a new checkout.
