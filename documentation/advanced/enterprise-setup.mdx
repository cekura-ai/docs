...
<Tip>
When creating resources like Dashboards, Metrics, or Evaluators via the API, you can omit the `project` field. Cekura automatically infers the project from your API key. If you provide a `project` field explicitly, that value takes precedence.
</Tip>
