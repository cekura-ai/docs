...
The plugin uses the US endpoint by default. If your Cekura workspace is in
India or EU, add the matching regional connection directly:
...
Use one MCP connection per workspace region. If you use a regional connection,
do not also enable the plugin's US connection, or Codex will show duplicate
Cekura tools.
