...
<Note>
**Scenario generation requirement**: To generate scenarios in a specific language, you must have at least one personality enabled for that language. If you request scenario generation in a language without an enabled personality, the system will prompt you to enable one first.
</Note>
