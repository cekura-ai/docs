...
Select your preferred connection type from the connections grid and click **Run**:

- **WebRTC**: For direct LiveKit room connection testing
- **Telephony**: For phone-based testing
- **Chat**: For text-based testing
...
The SDK automatically handles chat/text mode configuration when you select the Chat connection and run scenarios — **no code changes required**.
