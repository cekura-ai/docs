...
| Method | Endpoint |
|--------|----------|
| `POST` | `https://new-prod.cekura.ai/test_framework/v1/metrics-external/` |
...
```bash Curl
curl -X POST https://new-prod.cekura.ai/test_framework/v1/metrics-external/ \
...
async function createMetric(
  ...
  const url = 'https://new-prod.cekura.ai/test_framework/v1/metrics-external/';
