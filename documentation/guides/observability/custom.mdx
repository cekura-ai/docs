...
<Note>
**This endpoint is for production call monitoring** — observing actual calls that happen on your platform independently of Cekura. If you want to send transcripts for simulation test runs triggered by Cekura's Testing Agent, use the [Custom Integration webhook](/documentation/integrations/custom-integration) instead.
</Note>
