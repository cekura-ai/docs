...
For detailed agent setup instructions, see the [Agent Setup Guide](/documentation/key-concepts/agents/create-agent).
...
- [Agent Setup Guide](/documentation/key-concepts/agents/create-agent)
