...
Test your metric against historical calls at any time—whether you're creating a new metric or editing an existing one. This lets you validate your logic before saving.
...
<Steps>
  <Step title="Open Test Metric">
    Navigate to the **Test Metric** section within the metric builder.
  </Step>
  ...
  <Step title="Save the Metric">
    If satisfied with the results, click **Create Metric** or **Save** to apply your changes.
  </Step>
</Steps>
