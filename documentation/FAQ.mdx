...
## What audio formats are supported for uploading voice recordings?

When uploading voice recordings to Cekura's observability API, the following audio and video content types are supported:
...
**Other:**
- Binary streams (`application/octet-stream`, `binary/octet-stream`)

If you upload a file with an unsupported content type, the API returns an error indicating the invalid content type.

For more details on uploading call recordings, see the [Custom Observability guide](/documentation/guides/observability/custom).
