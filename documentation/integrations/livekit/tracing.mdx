...
<Note>
This data is ONLY available when using Option 2 (Automated LiveKit Testing) - running tests via "Run with LiveKit". Phone-based calls (Option 1) will return an empty object.
</Note>
