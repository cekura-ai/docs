...
**personality_ids** (array of numbers, optional): List of personality IDs to override for this run. If not provided, uses the scenario's default personality. When multiple personalities are specified, Cekura runs each scenario once per personality.

**test_profile_ids** (array of numbers, optional): List of test profile IDs to override for this run. If not provided, uses the scenario's default test profile. When multiple test profiles are specified, Cekura runs each scenario once per test profile.
