...
| Method | Endpoint |
|--------|----------|
| `GET` | `https://new-prod.cekura.ai/test_framework/v1/metrics-external/:metric_id/` |
...
```bash Curl
curl -X GET https://new-prod.cekura.ai/test_framework/v1/metrics-external/:metric_id/ \
