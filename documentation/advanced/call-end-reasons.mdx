...
<<<<<<< HEAD
- `customer-voicemail`: The call reached the customer's voicemail instead of connecting.
||||||| 0520b4c
...
<<<<<<< HEAD
- `customer-silence-timed-out`: Call ended due to prolonged silence from the customer.
||||||| 0520b4c
...
<<<<<<< HEAD
- `customer-invalid-phone-number`: The customer's phone number was invalid or unreachable.
||||||| 0520b4c
...
- `customer-call-not-connected`: Call failed to connect to the customer.
||||||| 0520b4c
- `call-not-connected`: Call failed to establish a connection.
=======
...
- `customer-twilio-client-error`: A Twilio client error occurred on the customer side.
...
- `assistant-did-not-connect`: The assistant failed to establish a connection.
...
<<<<<<< HEAD
- `assistant-pipeline-error`: A system or pipeline error occurred on the assistant side during the call.
- `assistant-recording-absent`: Call recording was not available from the assistant.
- `assistant-recording-failed`: Call recording failed on the assistant side.
||||||| 0520b4c
