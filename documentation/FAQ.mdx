...
## What is Daily AI Insights and how do I use it?

Daily AI Insights is an in-app feed that surfaces AI-summarized issues from your daily reports. It appears on the Alerts page in your Cekura dashboard, showing a status indicator, headline summary, and grouped issues for each day's calls.

### Where to Find Daily AI Insights

Go to the **Alerts** page in your project. The Daily AI Insights feed appears below the metric alerts section. New entries are added automatically after each daily report runs.

### What Each Entry Shows

Each insight card includes:
- **Status indicator**: A colored emoji (green, yellow, or red) showing overall health for that day
- **Headline**: A summary of the day's performance
- **Top issues**: Grouped problems identified across your calls, with context and patterns

### Asking Questions About Your Insights

Click the **Ask** button on any insight card to open an interactive chat. You can ask Claude questions about that specific day's data, and it will respond using both the summarized digest and the underlying call logs. This helps you investigate issues quickly without reviewing individual calls manually.

### Requirements

Daily AI Insights entries appear after the daily report dispatcher runs for your project. If no entries are visible, ensure your project has daily reports enabled and has logged calls to analyze.
