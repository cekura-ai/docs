...
| Method | Endpoint |
|--------|----------|
| `POST` | `https://new-prod.cekura.ai/observability/v1/call-logs-external/rerun_evaluation/` |
...
```bash Curl
curl -X POST https://new-prod.cekura.ai/observability/v1/call-logs-external/rerun_evaluation/ \
...
def reevaluate_calls(api_key, call_logs, agent_id=None):
    url = 'https://new-prod.cekura.ai/observability/v1/call-logs-external/rerun_evaluation/'
    headers = {
...
async function reevaluateCalls(apiKey, callLogs, agentId = null) {
  const url = 'https://new-prod.cekura.ai/observability/v1/call-logs-external/rerun_evaluation/';
