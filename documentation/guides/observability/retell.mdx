...
```
https://new-prod.cekura.ai/observability/v1/retell/observe/
```
...
Add the key from Retell with the tag `webhook` to Cekura in the Agent Settings page. Ensure you have copied your `agent ID` from Retell as well. 
