...
Yes, you can cancel your subscription directly from the Cekura dashboard.

To cancel your subscription:
1. Log in to your Cekura account.
2. Navigate to **Billing**.
3. Click **Cancel Plan**.
4. Confirm your cancellation in the dialog that appears.

Your subscription will remain active until the end of your current billing period. All your existing agent configurations, evaluators, and historical data will remain intact if you decide to resubscribe in the future.
