...
## How can I preview my daily report before enabling scheduled delivery?

You can generate and preview your daily observability report on-demand from the settings page to see exactly what the report contains before enabling scheduled email delivery.

### Accessing the Preview

1. Go to **Settings > Project > Observability Alerts**.
2. Find the **Daily Report** section.
3. Click **View Report** next to the Daily Report toggle.

### What the Preview Shows

The preview opens in a modal displaying your daily report as a PDF. The report includes:

- Key metrics and 24-hour trends
- Top metric insights
- Critical issues by category
- Failing rubric criteria
- Dashboard snapshots

### Preview Actions

- **Regenerate**: Generate a fresh report with the latest data
- **Download**: Open the PDF in a new tab for saving or sharing

### Important Notes

- **No notifications sent**: Previewing a report does not send any emails or trigger webhooks.
- **Cached data**: The preview may show cached data up to 15 minutes old. A banner indicates when the report was generated if cached data is displayed.
- **Generation time**: Initial report generation can take up to 20 seconds while dashboard snapshots render.
- **Empty state**: If there has been no call activity in the last 24 hours, the preview indicates there is nothing to report.
- **Enable prompt**: If daily reports are toggled off, the preview dialog prompts you to enable scheduled delivery.
- **Retention period**: Daily reports are retained for 30 days. Reports older than 30 days are automatically deleted and cannot be retrieved.
