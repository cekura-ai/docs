...
<Frame caption="A dashboard with its widget grid, date-range picker, and agent filter.">
  <img src="/images/dashboards/dashboard-view.png" alt="Dashboard view" />
</Frame>
...
- **Date range** — pick a time range (24h, 7d, 30d, and so on); all widgets
  update to that range.
...
<Frame caption="The widget editor — choose a field or metric, chart type, and aggregation.">
  <img src="/images/dashboards/widget-editor.png" alt="Widget editor" />
</Frame>
...
from a spike on the chart to the individual calls that caused it. For
metric-based widgets you can also create an [alert](/documentation/guides/observability/alerts)
