...
| Method | Endpoint |
|--------|----------|
| `GET` | `https://new-prod.cekura.ai/observability/v1/call-logs-external/:call_log_id/` |
...
```bash Curl
curl -X GET https://new-prod.cekura.ai/observability/v1/call-logs-external/:call_log_id/ \
